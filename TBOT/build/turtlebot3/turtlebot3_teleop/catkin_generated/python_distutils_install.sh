...
echo_and_run cd "/home/david/TBOT/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/david/TBOT/src/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/david/TBOT/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
